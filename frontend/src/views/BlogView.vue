    ...
    <div class="row">
      ...
      <div class="col align-self-center" style="height: 60%;">
        <div class="col text-left m-5">
          ...
          <v-btn outlined rounded color="teal" class="ma-1" v-for="hashtag in blogData.hashtags" :key="hashtag.tname">
          ...
          <div v-if="userInfo.email !== blogData.manager">
            ...
            <div v-else>
              <!-- 팔로우 하고 있는 경우 -->
              <v-btn color="secondary" small dark fab v-if="following" @click="clickFollow()">
                <v-icon dark>mdi-account-remove-outline</v-icon>
              </v-btn>

              <v-btn color="teal" small dark fab v-else @click="clickFollow()">
            ...
            <!-- Modal -->
            <div class="modal fade" id="leaveBlogModal" tabindex="-1" role="dialog"
              aria-labelledby="leaveBlogModalLabel" aria-hidden="true">
