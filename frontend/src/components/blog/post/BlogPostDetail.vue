...
=======
        ...
        <div style="margin-bottom: 10px">
          <p style="text-align: left; margin-bottom: 3px;">
            ...
            <span v-if="time.includes('전') == false" style="color: gray; font-size:13px;"> {{ $moment(time).format('YYYY.MM.DD HH:mm') }}</span>
            <span v-else style="color: gray; font-size:13px;"> {{ time }}</span>
          </p>
          <p v-if="postData.managerNickname != postData.authorNickname" style="text-align: left; margin-left: 16px; margin-bottom: 0px; font-size:14px;"><span style="font-weight: bold;">출처 | </span> {{ postData.authorNickname }}의 블로그</p>
        </div>
>>>>>>> fe9166601f0133d20402b01d61fac7c7143b2b01
        <hr>
